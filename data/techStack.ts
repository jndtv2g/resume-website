export const techStack = {
  ...
  "Testing Methodologies": ["Automation Testing", "Functional Testing", "Performance/Load Testing", "Regression Testing", "End-to-End Testing", "Exploratory Testing", "Sanity/Smoke Testing", "Accessibility Testing", "Gherkin"],
  "Test Management": ["TestRail", "Zephyr", "BrowserStack", "Qase.io", "Azure DevOps"],
  "Defect Management": ["Jira", "ClickUp", "Azure DevOps"],
  "Debugging & Monitoring Tools": ["Postman", "Grafana K6", "Jmeter", "Fiddler", "Sumo Logic", "Screencopy", "Vysor", "Laravel Telescope"],
