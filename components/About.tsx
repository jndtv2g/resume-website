...
export default function About() {
  return (
    <div className="bento-card p-4 col-span-1 md:col-span-4 space-y-2 group animate-fade-in">
      ...
      I am a Senior QA Engineer with over five years of experience delivering high-quality software across ERP, e-commerce, and SaaS platforms. I specialize in functional, regression, integration, and automation testing, with a strong focus on building reliable and maintainable test suites. <br/><br/>
